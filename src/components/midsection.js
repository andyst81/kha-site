			...
			<div className="container">
				<div className="columns">
					<div className="column is-6">
						...
						<hr className="content-divider" />
						<a href="/gallery" className="button is-white is-inverted"><span className="pr-2">Gallery</span><i className="fas fa-chevron-right"></i></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div className="container">
			<div className="columns">
				<div className="column is-6 line">
					...
					<a href="https://lin.ee/OqDH7lU"><img height="36" border="0" src="https://scdn.line-apps.com/n/line_add_friends/btn/en.png" alt='QR code for adding Line friend'/></a>				
				</div>
				<div className="column is-6">
